...
class my_string {
 ...
 public:
    ...
    my_string insert(size_type index , char charToInsert);
    my_string append(my_string stringToAppend);
    my_string push_back(char charToPushback);
    // capacity
    bool empty() const;
    ...
    size_type find_first_not_of(my_string x);
